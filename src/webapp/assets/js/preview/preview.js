...
this.imagePreview=function(d,c){
	...
	$(c).hover(function(e){
		$("body").append("<div id='preview' class='previewShowWindow'><img onload='AutoResizeImage("+ari_width+","+ari_heigth+",this)' id='pi' src='images/loadingAnimation.gif' alt='Now Loading' /></div>");
