...
public class MessageConstants {
	...
	public final static class UserMessageNodeId{
		 ...
		 * 使用手机号登陆
		 */
		public final static String LOGIN_BY_MOBILE = "login_by_mobile";
		
		/**
		 * 生日发送短信
		 */
		public final static String BIRTHDAY_BY_MOBILE_NUMBER="birthday_by_mobile_number";
		
		/**
		 * 提现失败发送短信
		 */
		public final static String WITHDRAW_FAIL_SMS="withdraw_fail";
		
		/**
		 * 注册成功
		 */
		public final static String LINE_REG_MESSAGE_SMS="line_reg_message";
	}
