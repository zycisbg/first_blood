    ...
    public static String createCSV(List headers, List data, List columns) {
        ...
        while (itr.hasNext()) {
            ...
            if (cls != null && cls.isArray()) {
                ...
                if (null == columns || columns.isEmpty()) { // 如果没有限制，默认全部显示
                    Set<Map.Entry<String, Object>> entries = objmodel.getAttrsEntrySet();
    ...
    public static void createCol(StringBuffer strOut, Object obj) {
        if (obj != null) {
            ...
            if (obj instanceof Boolean) {
                ...
                content = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date(((Timestamp) obj).getTime()));
            } else if (obj instanceof Date) {
                content = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format((Date) obj);
            } else {
