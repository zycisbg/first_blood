...
/*******************************************************************************
 * Description: 图片水印工具类
 * @author http://blog.csdn.net/zengshunyao/article/details/44758297
 * @version 1.0
 */
public class ImageRemarkUtil {
    ...
    public static void markImageByIcon(String iconPath, String srcImgPath,
        ...
        try {
            ...
            //按使用者要求，把原图片大小改为950*1050
            BufferedImage buffImg = new BufferedImage(950,
                    1050, BufferedImage.TYPE_INT_RGB);
            ...
            g.drawImage(
                    srcImg.getScaledInstance(950,
                            1050, Image.SCALE_SMOOTH), 0, 0,
                    null);
            // 3、设置水印旋转
            if (null != degree) {
    ...
    public static void main(String[] args) {
        String srcImgPath = "E:/photo/305272941593239160.jpg";
        String iconPath = "E:/photo/12354.png";


        String targerIconPath = "E:/photo/1238.jpg";

        setImageMarkOptions(0.7f, 279, 477, null, null);
        // 给图片添加水印图片
